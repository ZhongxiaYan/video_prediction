...
class ResidualConv(NNBase):
    ...
    def f_dec(self, input):
        ...
        with tf.variable_scope('f_dec'):
            deconv3_4 = deconv(input, 3, 512, 2, 'deconv3_4')            
            deconv3_3 = deconv(deconv3_4, 3, 512, 1, 'deconv3_3')
            deconv3_2 = deconv(deconv3_3, 3, 512, 1, 'deconv3_2')
            deconv3_1 = deconv(deconv3_2, 3, 256, 2, 'deconv3_1')
            
            deconv2_2 = deconv(deconv3_1, 3, 256, 1, 'deconv2_2')
            deconv2_1 = deconv(deconv2_2, 3, 128, 2, 'deconv2_1')

            deconv1_2 = deconv(deconv2_1, 3, 128, 1, 'deconv1_2')
